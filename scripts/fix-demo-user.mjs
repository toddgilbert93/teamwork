...
const DEFAULT_PERSONAS = [
  { name: 'Sol', emoji: '☀️', accent_color: '#F59E0B', tagline: 'Optimistic strategist who biases toward action', sort_order: 1, is_default: true,
  ...
  { name: 'Mira', emoji: '🔮', accent_color: '#3B82F6', tagline: "Reflective thinker who sees what you're really saying", sort_order: 2, is_default: true,
  ...
  { name: 'Dash', emoji: '⚡', accent_color: '#F97316', tagline: 'Builder and maker who thinks by doing', sort_order: 3, is_default: true,
  ...
  { name: 'Rex', emoji: '😈', accent_color: '#78716C', tagline: 'Brutally honest with a dry wit and a hidden heart', sort_order: 4, is_default: true,
  ...
  { name: 'Mean guy', emoji: '🤖', accent_color: '#06B6D4', tagline: 'bad apple', sort_order: 5, is_default: true,
  ...
  { name: 'Atlas', emoji: '😴', accent_color: '#06B6D4', tagline: 'unhelpful', sort_order: 6, is_default: true,
