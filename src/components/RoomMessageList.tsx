        ...
        <div className="flex flex-col items-center justify-center h-full text-center">
          <div className="flex -space-x-2 mb-4">
            {personas.map((p) => (
              <div
                key={p.id}
                className="w-12 h-12 rounded-xl flex items-center justify-center text-xl ring-2 ring-[#faf9f6]"
          ...
          <p className="text-sm text-gray-500 max-w-sm">
            Send a message and all your companions will join in.
          </p>
        </div>
      )}
          ...
          <div className="flex justify-start">
            <div className="max-w-[80%]">
              ...
              <div
                ...
                style={{ backgroundColor: p.accent_color + '10' }}
              >
                {streamingText ? (
